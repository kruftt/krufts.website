    ...
    <article>
      ...
      <SectionTabs tabs={['Explosive Bomb', 'Smooth Armor Scaling', 'Resource Cost Scaling']}>
        <SectionTabsContent value='Explosive Bomb'>
          <p>
            During a stream, I overheard a Valheim player complaining that there was just no good way to speed up mining during certain key progression choke points, like the swamps. <a href="https://thunderstore.io/c/valheim/p/kruft/Explosive_Bomb/">Explosive Bomb</a> was designed, in part, to remedy this gap. Although quite powerful at the point it becomes available, early in the second progression tier, it requires a Surtling Core, which are hard to come by at that stage of the game. I've balanced the item to be great for mining, good for chopping trees, and decent in early combat, its many uses making up for its moderately expensive price.
          </p>
          <p>
