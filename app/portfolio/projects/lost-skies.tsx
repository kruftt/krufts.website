    ...
    <article>
      ...
      <SectionTabs tabs={['Overview', 'Point to Interact', 'Infested Bunker']}>
        <SectionTabsContent value='Overview'>
          <section>
            <p>
              During its Early Access period, I made several mods for a survival-crafting game called <a href="https://lostskiesgame.com">Lost Skies</a>. I helped initiate the modding community by documenting my code, workflow, and project configuration for others. This included setting up a C# build environment and writing a custom <a href="https://github.com/kruftt/ThunderstoreAdapter">msbuild task library</a> for compiling mods and packaging them for distribution on <a href="https://thunderstore.io">thunderstore.io</a>.
            </p>
            <p>
              In early development, the game was built on a Mono C# backend, but later switched to an IL2CPP (Internal Language to C++) backend on the Early Access launch in order to enhance security. While this made reverse-engineering and modding significantly more difficult (by preventing decompilation and/or transpilation of the IL assemblies), it gave me an opportunity to learn about the IL2CPP compiler and to explore methods of reverse-engineering native assemblies, such as using tools like Ghidra or IDA pro.
            </p>
          </section>
          <ArticleCarousel>
            <CarouselItem>
              <div className="flex justify-center items-center gap-4">
                <a className="max-w-[calc(33%-8px)]" href="https://thunderstore.io/c/lost-skies/p/kruft/Herald_Tracker/">
                  <img src="/img/ls_herald_tracker.png" alt="Herald Tracker." />
                </a>
                <a className="max-w-[calc(33%-8px)]" href="https://thunderstore.io/c/lost-skies/p/kruft/ShipCam_Pro/">
                  <img src="/img/ls_shipcam_pro.png" alt="Shipcam Pro." />
                </a>
                <a className="max-w-[calc(33%-8px)]" href="https://thunderstore.io/c/lost-skies/p/kruft/Point_To_Interact/">
                  <img src="/img/ls_point_to_interact.png" alt="Point To Interact." />
                </a>
              </div>
            </CarouselItem>
            <CarouselItem>
        ...
        <SectionTabsContent value='Point to Interact'>
          <section>
            <p>
              One such mod, <a href="https://github.com/kruftt/LostSkiesMods/blob/main/PointToInteract/src/Patch.cs">Point To Interact</a>, focused on user experience and improved 3d object selection/interaction. By default, every frame used a spherical collider to detect interactables around the player. These interactables were then displayed in a scrollable list, navigable with the mousewheel or a controller's d-pad. However, this system felt unintuitive when using a mouse, since pointing at an object didn't guarantee it would be selected.
            </p>
            <p>
              To address this I used a raycast from the camera to the cursor to filter the results of the proximity check. If no interactable is under the cursor, it falls back to the default behavior. This significantly improves the functionality in common cluttered scenarios such as selecting between adjacent storage cabinets, as shown in the mod's cover image below, where the user would like to select the middle storage box of three vertically aligned boxes:
            </p>
          </section>
