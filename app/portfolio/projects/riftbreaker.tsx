    ...
    <article>
      ...
      <SectionTabs tabs={['Mods', 'RB-Reference']}>
        <SectionTabsContent value='Mods'>
          <div>
            In 2021 I developed several <a href="https://www.nexusmods.com/theriftbreaker/users/102065808?tab=user+files">mods</a> for <a href="https://www.riftbreaker.com">The RiftBreaker</a> by Exor Studios, which is built on their own C++/Lua game engine. I helped the modding community reverse-engineer the game's entity and event systems and shared several <a href="https://ccrma.stanford.edu/~doucette/gaming/code/entity_parser.py">utility scripts</a>, written in Python to help other mod authors. My final project was a parameterized script that could generate difficulty configurations (and the corresponding enemy spawn logic files) capable of completely rebalancing the entire game in one fell swoop.
          </div>
          <div className="mt-4">
            <img
              className="m-auto"
