		...
		<article>
			...
			<div>
				<p>
					...
					called <a href="https://chuck.cs.princeton.edu">ChucK</a>. My favorite
					to play with was the "Granular Torch", a particle emitter in which the
					height of the particles corresponded to playback positions in an audio
					signal, such that as the flame particles moved in space the audio
					signal was traversed/played. I thought it would be fun to extend it in
					the future to play different audio signals at different horizontal
					locations.
				</p>
			</div>
			<ArticleCarousel>
