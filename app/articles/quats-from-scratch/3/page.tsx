...
export default function Page3() {
  return (
    <article>
      ...
      <p>
        Now suppose we have taken the first green action, i. j has moved to k, while i, along the axis of rotation, has done a twist into -1. We take advantage of the anti-commutativity in the plane of rotation to undo this twist while doubling up on the rotation. Lets look at the next step, with the complex conjugate <MathInline>i^*</MathInline>, to undo the twist.
      </p>
