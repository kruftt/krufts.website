	...
	return (
		<div className="select-none">
			<div className={cn("w-full flex justify-center", className)}>
				<svg
					ref={svg}
					className="w-full max-w-70 aspect-square"
					viewBox="-55 -55 110 110"
				>
					<title>
						A unit vector rotating around the origin in either direction traces
						out a circle with sides being the cosine and sine of the angle,
						measured by the length of the arc.
					</title>
					<defs>
						<marker
							id="triangle"
					...
					<path
						...
						fill="#b3b100d0"
					></path>
					<path d={`M -50 0 L 50 0`} stroke="#000000d0" strokeWidth="1"></path>
					<path d={`M 0 -50 L 0 50`} stroke="#000000d0" strokeWidth="1"></path>
					<path
						d={`M 0 0 L ${p[0]} ${-p[1]}`}
						stroke="black"
						strokeWidth={2}
