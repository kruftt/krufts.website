    ...
    <article>
      <div>
        ...
        <ul className="list-disc ml-8 mt-4 mb-6">
          ...
          <li>Why do quaternions use only half of the intended rotation angle?</li>
          <li>How could Hamilton have conceived of quaternions <i>before</i> the standard vector operations were invented?</li>
        </ul>
        <p>
