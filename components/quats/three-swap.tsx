  ...
  return (
    <div className="">
        ...
        <svg ref={svg} className="m-auto w-full max-w-90 aspect-13/10" viewBox="-55 -55 110 143">
          ...
          <circle className="transition-transform duration-200" ref={red} cx="0" cy="0" r="9" stroke="none" fill="#a01752" opacity={0.7} transform={positions[0]}></circle>
          <circle className="transition-transform duration-200" ref={green} cx="0" cy="0" r="9" stroke="none" fill="#0c8773" opacity={0.7} transform={positions[1]}></circle>
          <circle className="transition-transform duration-200" ref={yellow} cx="0" cy="0" r="9" stroke="none" fill="#b3b100" opacity={0.7} transform={positions[2]}></circle>
          <circle className="transition-transform duration-200" ref={blue} cx="0" cy="0" r="9" stroke="none" fill="#2468a7" opacity={0.7} transform={positions[3]}></circle>
          ...
          <circle className="transition-transform duration-200" ref={red} cx="0" cy="78" r="9" stroke="none" fill="#a01752" opacity={0.7} transform={bottomPositions[0]}></circle>
          <circle className="transition-transform duration-200" ref={green} cx="0" cy="78" r="9" stroke="none" fill="#0c8773" opacity={0.7} transform={bottomPositions[1]}></circle>
          <circle className="transition-transform duration-200" ref={yellow} cx="0" cy="78" r="9" stroke="none" fill="#b3b100" opacity={0.7} transform={bottomPositions[2]}></circle>
          <circle className="transition-transform duration-200" ref={blue} cx="0" cy="78" r="9" stroke="none" fill="#2468a7" opacity={0.7} transform={bottomPositions[3]}></circle>
        </svg>
